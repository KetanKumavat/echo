...
export default function Signup() {
  ...
  return (
    <div className="max-w-md w-full mt-[25vh] mx-auto rounded-none md:rounded-2xl p-4 md:p-8 shadow-input bg-white dark:bg-black">
      ...
      <form className="my-8" onSubmit={handleSubmit}>
        ...
        <LabelInputContainer className="mb-4">
          ...
          <Input
            id="email"
            placeholder="help-echo@gmail.com"
            type="email"
            value={email}
